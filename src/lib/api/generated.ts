...
export interface paths {
	...
	'/api/v1/faces/suggestions/persons/{person_id}/find-more': {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		put?: never;
		/**
		 * Start job to find more suggestions using dynamic prototypes
		 * @description Samples random labeled faces (weighted by quality and diversity)
		 ...
		 */
		post: operations['start_find_more_suggestions_api_v1_faces_suggestions_persons__person_id__find_more_post'];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	'/api/v1/job-progress/events': {
		 ...
		 * @description Opens an SSE connection that streams progress updates for a background job.
		 *
		 ...
		 */
		get: operations['stream_job_events_api_v1_job_progress_events_get'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
	...
	'/api/v1/job-progress/status': {
		 ...
		 */
		get: operations['get_job_status_api_v1_job_progress_status_get'];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
...
export interface components {
	schemas: {
		...
		BulkSuggestionActionResponse: {
			 ...
			 */
			findMoreJobs?: components['schemas']['FindMoreJobInfo'][] | null;
		};
		/**
		 * CameraMetadata
		...
		/**
		 * FindMoreJobInfo
		 * @description Info about an auto-triggered find-more job.
		 */
		FindMoreJobInfo: {
			/** Personid */
			personId: string;
		...
		/**
		 * FindMoreJobResponse
		 * @description Response when starting a find-more job.
		 */
		FindMoreJobResponse: {
			/** Jobid */
			jobId: string;
		 ...
		 * @description Request to find more suggestions using random face sampling.
		 */
		FindMoreSuggestionsRequest: {
			/**
			 * Prototypecount
...
export interface operations {
	...
	start_find_more_suggestions_api_v1_faces_suggestions_persons__person_id__find_more_post: {
		parameters: {
			query?: never;
			header?: never;
			path: {
		...
		requestBody: {
			content: {
				'application/json': components['schemas']['FindMoreSuggestionsRequest'];
			};
		};
		responses: {
			/** @description Successful Response */
			201: {
				...
				content: {
					'application/json': components['schemas']['FindMoreJobResponse'];
				};
			};
			/** @description Validation Error */
			422: {
	...
	stream_job_events_api_v1_job_progress_events_get: {
		parameters: {
			query: {
				progress_key: string;
			};
	...
	get_job_status_api_v1_job_progress_status_get: {
		parameters: {
			query: {
				progress_key: string;
			};
